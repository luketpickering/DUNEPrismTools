...
namespace osc
{
  ...
  public:
    ...
    void SetL     (double L     ) { fL      = L;      fUpdated = false; }
    void SetRho   (double rho   ) { fRho    = rho ? rho : 1e-10; fUpdated = false;}
    void SetDmsq21(double dmsq21) { fDmsq21 = dmsq21; fUpdated = false; }
    void SetDmsq32(double dmsq32) { fDmsq32 = dmsq32; fUpdated = false; }
    void SetTh12  (double th12  ) { fTh12   = th12;   fUpdated = false; }
    void SetTh13  (double th13  ) { fTh13   = th13;   fUpdated = false; }
    void SetTh23  (double th23  ) { fTh23   = th23;   fUpdated = false; }
    void SetdCP   (double dCP   ) { fdCP    = dCP;    fUpdated = false; }
