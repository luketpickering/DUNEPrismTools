...
if [ ! -d "RHC/$1/processed$2/" ]; then
  mkdir RHC/$1/processed$2/
  echo "Made directory RHC/$1/processed$2"
fi
if [ ! -d "/home/calcuttj/DUNEPrismSim/RHC/$1/processed$2/" ]; then
  mkdir /home/calcuttj/DUNEPrismSim/RHC/$1/processed$2/
  echo "Made directory /home/calcuttj/DUNEPrismSim/RHC/$1/processed$2/"
fi
 
cat RHC_processor_input.list | while read line 
do
  echo $line
  string=$line
  IFS='.'
 ...
 # echo $run
  ...
  OUTFILE=RHC/$1/processed$2/processed.RHC.${array[0]}.${array[1]}.pbs

  cat $FILE > $OUTFILE  
  echo \#PBS -l file=20gb >> ${OUTFILE}
  echo \#PBS -N ${run}_analysis >> ${OUTFILE} 
  echo DATAPATH=/home/calcuttj/DUNEPrismSim/RHC/${1}/ >> ${OUTFILE}
  ...
  echo cp ${run}.\$\{PBS_JOBID\}.processed.root ~/DUNEPrismSim/RHC/$1/processed$2/ >> ${OUTFILE}
